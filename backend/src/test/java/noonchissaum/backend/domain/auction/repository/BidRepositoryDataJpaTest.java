...
class BidRepositoryDataJpaTest {
    ...
    void setUp() {
        ...
        a1 = runningAuction(i1, BigDecimal.valueOf(1000), now.plusDays(2)); // 중간
        a2 = runningAuction(i2, BigDecimal.valueOf(1000), now.plusDays(5)); // 가장 늦게 끝남 (desc 정렬에서 1등)
        a3 = runningAuction(i3, BigDecimal.valueOf(1000), now.plusDays(1)); // 가장 빨리 끝남
