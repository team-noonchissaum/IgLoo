...
public class BidServiceValidationTest {
    ...
    void setUp() {
        ...
        Category category = categoryRepository.save(new Category("val-cat-" + suffix, null));
        Item item = itemRepository.save(new Item(testUser, category, "validation-item-" + suffix, "desc", new BigDecimal("1000")));
        ...
        String statusKey = "auction:" + testAuction.getId() + ":status";
        ...
        redisTemplate.opsForValue().set(statusKey, AuctionStatus.RUNNING.name());
